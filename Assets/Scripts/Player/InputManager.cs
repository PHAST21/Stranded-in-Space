...
public class InputManager : MonoBehaviour
{
    ...
    [Tooltip("Whether the attack key is pressed or not")]
    public bool attackpressed = false;
    public void GetAttackInput(InputAction.CallbackContext callbackContext)
    {
        
        attackpressed = !callbackContext.canceled;
    }
}