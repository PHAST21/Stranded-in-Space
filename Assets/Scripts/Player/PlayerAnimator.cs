...
public class PlayerAnimator : MonoBehaviour
{
    ...
    void ReadPlayerStateAndAnimate()
    {
        ...
        if (playerController.state == PlayerController.PlayerState.Jetpack)
        {
            Jetpackanimator.SetBool("isUsingJetpack", true);
            jetpack.SetActive(true);

        }
        else
        {
            Jetpackanimator.SetBool("isUsingJetpack", false);
            jetpack.SetActive(false);
        }
        if (playerController.state == PlayerController.PlayerState.Attacking)
        {
            Hitbox.SetActive(true);
            HitboxAnim.SetBool("Attack", true);
        }
        else if(playerController.state != PlayerController.PlayerState.Attacking)
        
        {

            HitboxAnim.SetBool("Attack", false);
