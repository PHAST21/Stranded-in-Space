...
public class EnemyAnimator : MonoBehaviour
{
    ...
    public Color color = new Color(1, 1, 1, 1/255);
    ...
    private IEnumerator Blink(Color a)
    {
        float time = 0;
        SpriteRenderer playerSprite = Enemy;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            StartCoroutine(Blink(Enemycolor));
        }
    }
